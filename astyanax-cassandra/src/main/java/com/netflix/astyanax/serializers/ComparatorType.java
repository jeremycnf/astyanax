...
import astyanax.shaded.org.apache.cassandra.db.marshal.ShadedTypeParser;
...
//    REVERSEDTYPE("org.apache.cassandra.db.marshal.ReversedType", ReversedSerializer.get());
    ...
    ASCIITYPE("astyanax.shaded.org.apache.cassandra.db.marshal.AsciiType", AsciiSerializer.get()),
    BYTESTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.BytesType", ByteBufferSerializer.get()),
    INTEGERTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.IntegerType", BigIntegerSerializer.get()),
    INT32TYPE("astyanax.shaded.org.apache.cassandra.db.marshal.Int32Type", Int32Serializer.get()),
    DECIMALTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.DecimalType", BigDecimalSerializer.get()),
    LEXICALUUIDTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.LexicalUUIDType", UUIDSerializer.get()),
    LOCALBYPARTITIONERTYPE("astyanax.shaded..apache.cassandra.db.marshal.LocalByPartionerType", ByteBufferSerializer.get()), // FIXME
    LONGTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.LongType", LongSerializer.get()),
    TIMEUUIDTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.TimeUUIDType", TimeUUIDSerializer.get()),
    UTF8TYPE("astyanax.shaded.org.apache.cassandra.db.marshal.UTF8Type", StringSerializer.get()),
    COMPOSITETYPE("astyanax.shaded.org.apache.cassandra.db.marshal.CompositeType", CompositeSerializer.get()),
    DYNAMICCOMPOSITETYPE("astyanax.shaded..apache.cassandra.db.marshal.DynamicCompositeType", DynamicCompositeSerializer.get()),
    UUIDTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.UUIDType", UUIDSerializer.get()),
    COUNTERTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.CounterColumnType", LongSerializer.get()),
    DOUBLETYPE("astyanax.shaded.org.apache.cassandra.db.marshal.DoubleType", DoubleSerializer.get()),
    FLOATTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.FloatType", FloatSerializer.get()),
    BOOLEANTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.BooleanType", BooleanSerializer.get()),
    DATETYPE("astyanax.shaded.org.apache.cassandra.db.marshal.DateType", DateSerializer.get()),
    REVERSEDTYPE("astyanax.shaded.org.apache.cassandra.db.marshal.ReversedType", ReversedSerializer.get());
