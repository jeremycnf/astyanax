 ...
 *
 * Note that shading prefixes this class's package name with the shaded name (e.g. "astyanax.shaded.").
 *
...
public class ShadedTypeParser extends TypeParser {
    ...
    public static String getShadedClassName(String className){
        if(className.startsWith("astyanax.shaded.")){
            return className;
        } else if (className.contains(".")){
            return "astyanax.shaded." + className;
        } else {
            return "astyanax.shaded.org.apache.cassandra.db.marshal." + className;
        }
    }
    ...
    public static String getShadedTypeName(String typeName){
        ...
        } else if ( typeName.startsWith( "astyanax.shaded.org.apache.cassandra.db.marshal." ) ) {
            return typeName.substring( "astyanax.shaded.org.apache.cassandra.db.marshal.".length() );
        }
        return typeName;
    }
